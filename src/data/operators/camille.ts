...
const sheet: OperatorSheet = {
  ...
  attributes: {
    Strength: [13.4, 20, 40, 60, 80, 90],
    Agility: [17.78, 32.39, 52.38, 72.36, 92.35, 102.35],
    Intellect: [14.18, 48.33, 80.49, 112.65, 144.81, 160.89],
    Will: [11.34, 38.73, 64.58, 90.44, 116.29, 129.21],
    'Base ATK': [30, 1566.33, 2688.78, 3811.22, 4933.67, 5494.9],
    'Base HP': [500, 28.57, 46.71, 64.84, 82.98, 92.05],
  },
  talents: [
    {
      levels: 2,
